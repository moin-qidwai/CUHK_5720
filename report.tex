...
\usepackage{graphicx}
\graphicspath{ {./assets/}{./yjs/charts/half_second_90_users/}{./yjs/charts/quarter_second_90_users/}{./yjs/charts/half_second_180_users/}{./sharedb/charts/half_second_90_users/}{./sharedb/charts/quarter_second_90_users/}{./sharedb/charts/half_second_180_users/} }
...
\begin{document}
  ...
  As we can see based on our algorithm YJS seems to clearly produce the more accurate document, in the case of ShareDB we see interleaving 
