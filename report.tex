...
\begin{document}
  ...
  We define a accuracy metric based on a simpler version of our insertion algorithm as shown in the below equations
  ...
  Ofcourse it's most popular use case may still remain to be offline P2P collaboration as that is simply not supported in ShareDB.
