...
\usepackage{graphicx}
\graphicspath{ {./yjs/charts/one_millisecond_del_60_users/}{./yjs/charts/one_millisecond_60_users/}{./yjs/charts/one_second_90_users/}{./yjs/charts/one_second_200_users/}{./yjs/charts/ten_seconds_90_users/} }
...
\begin{document}
  ...
  \begin{tabular}{||c c c c||} 
    ...
    D & Insert & 0.1 & 90 \\
    \hline
    E & Delete & 1000 & 60 \\ [1ex] 
    \hline
  \end{tabular}

  \subsection{Number Of Users}
  \subsubsection{YATA}
  Observe that the clients are being terminated by the OS due to low memory.
  ...
  \begin{center}
    ...
    \includegraphics[scale=0.48]{yjs_users_S4.png}
    
    \textbf{Scenario D}
    
    \includegraphics[scale=0.48]{yjs_users_S5.png}
  ...
  \subsubsection{YATA}
  Observe that CPU utilization is highly correlated to the document size.
  ...
  \\\\
  \begin{center}
    \includegraphics[scale=0.48]{yjs_cpu_S1.png}

    \textbf{Scenario A}
    
    \includegraphics[scale=0.48]{yjs_cpu_S2.png}
    
    \textbf{Scenario B}
    
    \includegraphics[scale=0.48]{yjs_cpu_S3.png}
    
    \textbf{Scenario C}

    \includegraphics[scale=0.48]{yjs_cpu_S4.png}
    
    \textbf{Scenario D}
    
    \includegraphics[scale=0.48]{yjs_cpu_S5.png}
  ...
  \begin{center}
    ...
    \includegraphics[scale=0.48]{yjs_memory_S4.png}
    
    \textbf{Scenario D}
    
    \includegraphics[scale=0.48]{yjs_memory_S5.png}
